...
public class PreResponseDecoder implements Decoder.Text<PreResponse> {

    @Override
    public PreResponse decode(String s) throws DecodeException {
        try {
            ObjectMapper mapper = new ObjectMapper();
            JsonNode rootNode = mapper.readTree(s);
            return mapper.treeToValue(rootNode, PreResponse.class);
        } catch (Exception e) {
            throw new DecodeException(s, "Error when decode pre-response.", e);
        }
    }
